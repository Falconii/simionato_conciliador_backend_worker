...
if (params) {
	...
	if(params.orderby == '') orderby = 'grupo.id_empresa,grupo.codigo';
	if(params.orderby == '000000') orderby = 'grupo.id_empresa,grupo.codigo';
	if(params.orderby == '000001') orderby = 'grupo.id_empresa,grupo.descricao';
