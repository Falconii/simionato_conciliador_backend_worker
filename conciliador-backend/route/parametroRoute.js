...
const parametroSrv = require('../../shared/service/parametroService');
...
router.get("/parametros", async function(req, res) {
        try {
...
router.post("/", async function(req, res) {
        console.log('parametroRoute - insertParametro', req.body);
        try {
...
router.post("/deleteparametro", async function(req, res) {
        try {
